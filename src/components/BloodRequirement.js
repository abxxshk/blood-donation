        ...
        <div className="form-container">
            ...
            {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit}>
                    <h1>Blood Requirement Application Form</h1>
                    ...
                    {errorMessages.age && <p style={{ color: 'red' }}>{errorMessages.age}</p>} 
                    ...
                    {errorMessages.contactNumber && <p style={{ color: 'red' }}>{errorMessages.contactNumber}</p>} 
